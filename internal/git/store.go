...
func (s *Store) VisibleIDs(userID string, isAdmin bool) ([]string, error) {
	var ownedIDs []string
...
func (s *Store) RequireOwner(id, userID string) (*models.GitIntegration, error) {
...
func (s *Store) LoadVisible(id, userID string, isAdmin bool) (*models.GitIntegration, error) {
...
func (s *Store) ListVisible(ids []string) ([]models.GitIntegration, error) {
...
func (s *Store) Create(m *models.GitIntegration) error {
...
func (s *Store) SetShares(integrationID string, projectIDs []string) error {
	return s.db.Transaction(func(tx *gorm.DB) error {
		...
		for _, pid := range projectIDs {
			if err := tx.Create(&models.GitIntegrationShare{
...
func (s *Store) Reload(m *models.GitIntegration) {
