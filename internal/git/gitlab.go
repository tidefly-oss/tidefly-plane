...
func (g *GitLab) GetInfo() ProviderInfo {
	return ProviderInfo{
		Type:        ProviderGitLab,
		DisplayName: "GitLab",
		BaseURL:     g.baseURL,
...
func (g *GitLab) GetRepository(ctx context.Context, owner, name string) (*Repository, error) {
...
func (g *GitLab) ListBranches(ctx context.Context, owner, name string) ([]Branch, error) {
	encoded := owner + "%2F" + name
