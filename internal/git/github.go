...
func (g *GitHub) GetInfo() ProviderInfo {
	return ProviderInfo{
		Type:        ProviderGitHub,
		DisplayName: "GitHub",
...
func (g *GitHub) GetRepository(ctx context.Context, owner, name string) (*Repository, error) {
...
func (g *GitHub) ListBranches(ctx context.Context, owner, name string) ([]Branch, error) {
