...
func (s *Service) ListForUser(userID string, isAdmin bool) ([]models.Project, error) {
	if isAdmin {
		return s.List()
	}
	var list []models.Project
...
func (s *Service) GetByID(id string) (models.Project, error) {
...
func (s *Service) Create(p *models.Project) error {
	return s.db.Create(p).Error
}

func (s *Service) Update(p *models.Project, fields UpdateFields) ([]string, error) {
...
func (s *Service) Delete(p *models.Project) error {
